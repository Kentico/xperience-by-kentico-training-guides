...
{
	/// <summary>
	/// Represents a page of type <see cref="ProductCategory"/>.
	/// </summary>
	[RegisterContentTypeMapping(CONTENT_TYPE_NAME)]
	public partial class ProductCategory : IWebPageFieldsSource, ISEOFields
	{
		/// <summary>
		/// Code name of the content type.
		/// </summary>
		public const string CONTENT_TYPE_NAME = "DancingGoat.ProductCategory";
