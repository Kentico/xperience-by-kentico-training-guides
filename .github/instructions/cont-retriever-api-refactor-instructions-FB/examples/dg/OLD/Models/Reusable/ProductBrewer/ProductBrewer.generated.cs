...
{
	/// <summary>
	/// Represents a content item of type <see cref="ProductBrewer"/>.
	/// </summary>
	[RegisterContentTypeMapping(CONTENT_TYPE_NAME)]
	public partial class ProductBrewer : IContentItemFieldsSource, IProductFields, IProductSKU, IProductManufacturer
	{
		/// <summary>
		/// Code name of the content type.
		/// </summary>
		public const string CONTENT_TYPE_NAME = "DancingGoat.ProductBrewer";
