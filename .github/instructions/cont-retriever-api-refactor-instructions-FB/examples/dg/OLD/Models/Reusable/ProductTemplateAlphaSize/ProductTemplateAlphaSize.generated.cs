...
{
	/// <summary>
	/// Represents a content item of type <see cref="ProductTemplateAlphaSize"/>.
	/// </summary>
	[RegisterContentTypeMapping(CONTENT_TYPE_NAME)]
	public partial class ProductTemplateAlphaSize : IContentItemFieldsSource, IProductFields, IProductManufacturer
	{
		/// <summary>
		/// Code name of the content type.
		/// </summary>
		public const string CONTENT_TYPE_NAME = "DancingGoat.ProductTemplateAlphaSize";
		...
		/// ProductVariants.
		/// </summary>
		public IEnumerable<ProductVariantAlphaSize> ProductVariants { get; set; }
