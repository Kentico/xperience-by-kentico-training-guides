...
{
	/// <summary>
	/// Represents a content item of type <see cref="ProductCoffee"/>.
	/// </summary>
	[RegisterContentTypeMapping(CONTENT_TYPE_NAME)]
	public partial class ProductCoffee : IContentItemFieldsSource, IProductFields, IProductSKU
	{
		/// <summary>
		/// Code name of the content type.
		/// </summary>
		public const string CONTENT_TYPE_NAME = "DancingGoat.ProductCoffee";
