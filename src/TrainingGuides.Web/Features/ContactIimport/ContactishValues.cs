...
internal static class ContactishValues
{
    ...
    // Create a dummy contact group so you can see how its dynamic condition is structured in the database
    ...
    // Custom fields in ContactInfo class
