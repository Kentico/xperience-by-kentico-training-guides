...
public class ProductListingWidgetProperties : IWidgetProperties
{
    ...
    [DropDownComponent(
        ...
        // See the finished branch for an example of using the SecuredOption enum to populate dropdown options with descriptions
        Options = "IncludeEverything;Include everything\r\nPromptForLogin;Prompt for login\r\nHideSecuredItems;Hide secured items",
        Order = 40)]
